	...
	return (
		<div className='max-w-5xl mx-auto'>
			<div className='flex flex-col justify-center items-center mt-20 shadow-2xl p-4  mx-2 lg:mx-0 '>
				...
				<p className='mb-4 text-lg font-mono font-bold text-center'>
					If deleted this action can not be reverted
				</p>
				<div className='flex flex-col justify-center items-center w-full'>
					<Button
						className='delete-btn'
						onClick={handleDeleteMovie}
						value='Yes, I Want To Delete This Movie'
					/>
					<div>
						<Button
							className='delete-btn2'
							onClick={handleCancelMovie}
							value='No, Cancel'
						/>
					</div>
				</div>
